...
<div class="row  border-bottom white-bg dashboard-header">
    ...
    <div class="col-sm-3">
        ...
        <br>
        <br>
        <img src="${pageContext.request.contextPath}/images/qr_code.png" width="100%" style="max-width:264px;">
        <br>
    </div>
    <div class="col-sm-5">
        <h2>
        ...
        <div class="col-sm-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <p id="pay-qrcode">
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/pay.png" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                        </a>
                    </p>
